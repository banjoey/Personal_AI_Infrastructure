...
**Context**: Alert: "HighErrorRate on gitlab-mcp"
...
**2. Impact**:
- Is this affecting users? GitLab MCP is internal tooling.
...
**Biases** (intentional):
- ⚠️ May over-instrument simple services
- ⚠️ Can be pessimistic ("what could go wrong?")
