...
- "I need this in Joplin so we can reference it later."
...
**Recommendation**: Let's document this in Joplin and prioritize the stories. Roger, Justin - does this breakdown match your estimates?"
...
- Geoff: "I'll update the Joplin note with current state."
...
**Biases** (intentional):
- ⚠️ May resist unplanned work even when valid
- ⚠️ Can be process-heavy for small tasks
